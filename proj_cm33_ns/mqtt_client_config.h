...
*
* Description: MQTT client configuration for TESAIoT Platform - MUTUAL TLS (mTLS)
* Device ID: 8fa124b0-a8e7-433a-8c95-417eb933322b
* Generated: 2026-01-22T15:18:47.377084+00:00
* Algorithm: ECC-256
*
* Instructions:
* 1. Replace the content in your mqtt_client_config.h with this configuration
* 2. This uses mutual TLS mode (client certificate required)
* 3. The device must present both CA certificate and client certificate/key
* 4. Higher security but requires more device resources
*
 ...
 * For Trust M devices: Use Trust M UID (54 hex characters)
 * For standard devices: Use device_id (typically UUID, 36 characters)
 */
#define DEVICE_ID                         "8fa124b0-a8e7-433a-8c95-417eb933322b"
 ...
 * MUTUAL TLS MODE: Configured for two-way authentication
 * - Using port 8883 (MQTTs) with mutual TLS authentication
 * - Device configured in platform with auth_mode: "mutual_tls" or "mtls"
 * - Both CA certificate AND client certificate/key required
 ...
 * For Trust M devices: Use Trust M UID (54 hex characters) as client_id
 * For standard mTLS: Use device_id (typically UUID, 36 characters)
...
"-----BEGIN CERTIFICATE-----\n" \
"MIICljCCAX6gAwIBAgIUDBFXNRybZUDTsXWSMv4R8LoOVucwDQYJKoZIhvcNAQEL\n" \
"BQAwIjEgMB4GA1UEAxMXVEVTQUlvVCBJbnRlcm1lZGlhdGUgQ0EwHhcNMjYwMTIy\n" \
"MTUxNzM1WhcNMjcwMTIyMTUxODA1WjAvMS0wKwYDVQQDEyQ4ZmExMjRiMC1hOGU3\n" \
"LTQzM2EtOGM5NS00MTdlYjkzMzMyMmIwWTATBgcqhkjOPQIBBggqhkjOPQMBBwNC\n" \
"AAROAapOGIN8WW4TonH1f5xfOnA+VoBqi02gJ6LPIL6X+OBF1A98ydjGeShQ2i1Z\n" \
"WKlXZvFTs3tr8ZS2MzEctveAo4GBMH8wDgYDVR0PAQH/BAQDAgOoMBMGA1UdJQQM\n" \
"MAoGCCsGAQUFBwMCMB0GA1UdDgQWBBSiFe6fTd38lrP0JK49/7f5+4ly0jAfBgNV\n" \
"HSMEGDAWgBRg6/1UTXnKJ2mxnp9PRGFjBdW4mDAYBgNVHREEETAPgg0qLnRlc2Fp\n" \
"b3QuY29tMA0GCSqGSIb3DQEBCwUAA4IBAQChmRvdt5b9K/l6n4PvRBHCz2QIjxC4\n" \
"5ufYEXEVCzPY09puA7oossRceaj7hi8Vk4wAm2aNMTx+CPWMTrGA9pn8PisSjE2H\n" \
"qr1dJDwaWxveV1pvt0PyjfKGqmukWZNKf/+mYTmx7BYb1oFCrfU15t7+7peoWsi2\n" \
"uMFrQrDDgiw4or+y9aG3Ln2EwiGLyZlPl4faSWTwlQ71qzAKOAEwzQ+vRXyb8NH3\n" \
"oRF9wLa7U1VTQ5GxCACl6xtNGa8nvOjdxMLoK2YTPp/kdFjY5fc0jxaGAmJ0uFnn\n" \
"qIU7aJN4VRXxnN6HjNwjDKLEdNuHRxM44blUlV5Q0XOMQ892V05rse34\n" \
"-----END CERTIFICATE-----\n"

/* PEM-encoded client private key */
#define CLIENT_PRIVATE_KEY \
"-----BEGIN EC PRIVATE KEY-----\n" \
"MHcCAQEEIH04EE9ylXCpJMJnmgmgfxc6B+oHFOUF/QrnPYW8Lh83oAoGCCqGSM49\n" \
"AwEHoUQDQgAETgGqThiDfFluE6Jx9X+cXzpwPlaAaotNoCeizyC+l/jgRdQPfMnY\n" \
"xnkoUNotWVipV2bxU7N7a/GUtjMxHLb3gA==\n" \
"-----END EC PRIVATE KEY-----\n"
